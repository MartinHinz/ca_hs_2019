...
subtitle: "02 - Your Compute as research tool"
author: "Martin Hinz"
...
- Statistics, GUI: [PAST](http://folk.uio.no/ohammer/past)
- Statistics, script: [R](https://www.r-project.org/) & [RStudio](https://www.rstudio.com/products/RStudio/)
...
- literature search Switzerland: [swissbib](https://www.swissbib.ch/)
- literature search worldwide: [WorldCat](https://www.worldcat.org/)
- literature search ancient studies: [Zenon](https://zenon.dainst.org/)


### limited recommendability

- cloud hosting [Dropbox](https://www.dropbox.com)
- file transfer [WeTransfer](https://wetransfer.com/)
