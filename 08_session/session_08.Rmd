...
- import csv-file (add Delimited Text layer) [miskovice_graves_data.csv](miskovice_graves_data.csv)
...
- import csv-file (add Delimited Text layer) [miskovice_types_per_graves.csv](miskovice_types_per_graves.csv)
