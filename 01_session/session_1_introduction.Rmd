...
---
## What is not computational archaeology
...
schedule <- c(
  ...
  "25/09/19", "Your Compute as research tools", "Libre Office Writer, Zotero",
  ...
  "30/10/19", "Visualisation II","Libre Office Calc, TOSCA",
  "06/11/19", "Basic Statistics / Hypothese testing", "Libre Office Calc",
...
- record informations in the field
- measure and geolocalise finds
- document features (eg. orthophoto)
- make 3D models
  - of terrain and architecture
  - artefacts

![:width 26%](../images/01_session/31021231223_e336cfc4bc_b.jpg)
![:width 40%](../images/01_session/ls13-colorstripping_curvature_mapping.jpg)
![:width 27%](../images/01_session/sfm.png)
...
- Overview about methods for digital documentation and recording
- devices, software, techniques
